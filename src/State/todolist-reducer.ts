...
type REMOVE_TODOLISTactionType = {
type: "REMOVE_TODOLIST",
id: string
}
type ADD_TODOLISTactionType = {
type: "ADD_TODOLIST",
title: string
}
...
export const AddTodolistAC = (newListTitle:string): ADD_TODOLISTactionType => {return {type: "ADD_TODOLIST", title: newListTitle}}
